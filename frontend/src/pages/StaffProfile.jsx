...
export default function StaffProfile() {
  ...
  async function handleSubmit(e) {
    ...
    setSaved(false);
    try {
      const updated = await api.updateStaffProfile({ full_name: fullName || null, email: email || null });
      setMe(updated);
      setSaved(true);
    } catch (e) {
  ...
  async function handleChangePassword(e) {
    ...
    try {
      await api.changeStaffPassword({ current_password: currentPassword, new_password: newPassword });
